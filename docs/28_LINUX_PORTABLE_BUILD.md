...
현재 검수본의 임시 빌드 기록은 `docs/29_LINUX_RELEASE_VERIFICATION.md`에 있다. 사용자 배포본은
만료 없는 GitHub Release에서 받는다.
...
bash packaging/package_linux_release.sh \
  LiDARLabelTool_Integrated_0.2.2_linux_x86_64
```
